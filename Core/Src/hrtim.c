...
//  }
  ...
  //pOutputCfg.ResetSource = HRTIM_OUTPUTRESET_TIMCMP1|HRTIM_OUTPUTRESET_EEV_1;
  ...
  pOutputCfg.ResetSource = HRTIM_OUTPUTRESET_TIMCMP3;
	//pOutputCfg.ResetSource = HRTIM_OUTPUTRESET_TIMCMP3|HRTIM_OUTPUTRESET_EEV_1;
...
void HAL_HRTIM_MspInit(HRTIM_HandleTypeDef* hrtimHandle)
{
  ...
  /* USER CODE END HRTIM1_MspInit 0 */
    ...
    HAL_NVIC_SetPriority(HRTIM1_TIMA_IRQn, 10, 0);
